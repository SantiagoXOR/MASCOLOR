-- Optimización de la base de datos para +COLOR
-- Este archivo contiene consultas SQL para optimizar el rendimiento de la base de datos
...
ALTER COLUMN name SET NOT NULL,
ALTER COLUMN slug SET NOT NULL,
ADD CONSTRAINT unique_brand_slug UNIQUE (slug);
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_products_with_relations AS
SELECT 
  p.*,
