          ...
          <div className="products-grid">
            <div className="product-card">
              ...
              <div className="product-content">
                ...
                <p className="product-description">
                  Pintura de alta calidad para interiores con acabado mate.
                </p>
            ...
            <div className="product-card">
              ...
              <div className="product-content">
                ...
                <p className="product-description">
                  Pintura resistente a la intemperie para exteriores.
                </p>
            ...
            <div className="product-card">
              ...
              <div className="product-content">
                ...
                <p className="product-description">
                  Revestimiento texturado para paredes exteriores.
                </p>
            ...
            <div className="product-card">
              ...
              <div className="product-content">
                ...
                <p className="product-description">
                  Esmalte ecológico al agua sin olor.
                </p>
          ...
          <div className="products-grid">
            <div className="product-card" style={{ backgroundColor: "white" }}>
              <div className="product-content">
                ...
                <p className="product-description">
                  Nuestras pinturas ofrecen una excelente cobertura con menos
                  capas, ahorrando tiempo y dinero.
                </p>
              </div>
            </div>
            <div className="product-card" style={{ backgroundColor: "white" }}>
              <div className="product-content">
                ...
                <p className="product-description">
                  Productos resistentes a la intemperie, rayos UV y condiciones
                  climáticas extremas.
                </p>
              </div>
            </div>
            <div className="product-card" style={{ backgroundColor: "white" }}>
              <div className="product-content">
                ...
                <p className="product-description">
                  Fórmulas de secado rápido que permiten terminar tus proyectos
                  en menos tiempo.
                </p>
              </div>
            </div>
            <div className="product-card" style={{ backgroundColor: "white" }}>
              <div className="product-content">
                ...
                <p className="product-description">
                  Productos con bajo contenido de VOC, amigables con el medio
                  ambiente y tu salud.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              >
                ...
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  <a href="tel:+541112345678" style={{ color: "#FF5722" }}>
                    +54 11 1234-5678
                  </a>
                </div>
                <div>
        ...
        <div className="container">
          <div className="footer-grid">
            <div>
              ...
              <p style={{ color: "#9E9E9E", marginBottom: "1rem" }}>
                Pinturas y revestimientos de alta calidad para tus proyectos de
                construcción y decoración.
              </p>
            ...
            <div>
              ...
              <div style={{ color: "#9E9E9E" }}>
                <div style={{ marginBottom: "0.5rem" }}>
                  <span style={{ color: "#FF5722", marginRight: "0.5rem" }}>
                    ✉
                  </span>
                  <a
                    href="mailto:info@mascolor.com"
                ...
                <div style={{ marginBottom: "0.5rem" }}>
                  ...
                  <a href="tel:+541112345678" style={{ color: "#9E9E9E" }}>
                    +54 11 1234-5678
                  </a>
                </div>
                <div>
          ...
          <div className="footer-bottom">
            <p>
              &copy; {new Date().getFullYear()} +COLOR. Todos los derechos
              reservados.
            </p>
          </div>
        </div>
